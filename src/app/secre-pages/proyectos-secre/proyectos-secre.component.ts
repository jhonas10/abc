...
@Component({
  selector: 'app-proyectos-secre',
  templateUrl: './proyectos-secre.component.html',
  styleUrls: ['./proyectos-secre.component.css'],
  providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
  ],
})
export class ProyectosSecreComponent implements OnInit {
...
//---------------- DOCUMENTOS -----------
  ...
  cargarDocumentos(proyectoKey:string){
    this.proyectoService.getDocumentosGuardados(proyectoKey).snapshotChanges().pipe(
      map(changes=>
        //key obtiene el id del doc
        changes.map(c=>
          ({ ...c.payload.doc.data()})
  ...
  subirDocumentos(proyectoKey:string, nombreProyecto:string){
    ...
    Swal.fire({
      ...
      if ( resp.value ) {
        ...
        this.proyectoService.cargarDocumentosFirebase( proyectoKey, nombreProyecto ,this.archivos);
